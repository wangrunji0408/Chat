...
namespace Chat.Connection.Grpc {
  public static partial class ChatServerService
  {
    ...
    static readonly grpc::Marshaller<global::Chat.Connection.Grpc.GetMessagesRequest> __Marshaller_GetMessagesRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Chat.Connection.Grpc.GetMessagesRequest.Parser.ParseFrom);
    ...
    static readonly grpc::Method<global::Chat.Connection.Grpc.GetMessagesRequest, global::Chat.Core.Models.ChatMessage> __Method_GetMessages = new grpc::Method<global::Chat.Connection.Grpc.GetMessagesRequest, global::Chat.Core.Models.ChatMessage>(
    ...
    public abstract partial class ChatServerServiceBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task GetMessages(global::Chat.Connection.Grpc.GetMessagesRequest request, grpc::IServerStreamWriter<global::Chat.Core.Models.ChatMessage> responseStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public partial class ChatServerServiceClient : grpc::ClientBase<ChatServerServiceClient>
    {
      ...
      /// <param name="cancellationToken">An optional token for canceling the call.</param>
      /// <returns>The call object.</returns>
      public virtual grpc::AsyncServerStreamingCall<global::Chat.Core.Models.ChatMessage> GetMessages(global::Chat.Connection.Grpc.GetMessagesRequest request, grpc::Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken))
      {
      ...
      /// <param name="options">The options for the call.</param>
      /// <returns>The call object.</returns>
      public virtual grpc::AsyncServerStreamingCall<global::Chat.Core.Models.ChatMessage> GetMessages(global::Chat.Connection.Grpc.GetMessagesRequest request, grpc::CallOptions options)
      {
